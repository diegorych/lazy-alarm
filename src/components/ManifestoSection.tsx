...
const ManifestoSection = () => {
  ...
  return (
    <div 
      ...
      className="min-h-screen flex flex-col items-center justify-center px-10 py-12 bg-black text-white"
    >
      {/* Title */}
      <div 
      ...
      >
        <h2 className="text-xs tracking-[0.25em] md:text-sm font-medium text-center uppercase text-neutral-400">
          THIS ISN'T AN ALARM
        </h2>
      </div>
      ...
      <div className="max-w-2xl w-full space-y-6">
        <p 
          className={`text-base md:text-lg font-normal leading-relaxed text-left transition-all duration-1000 ease-out ${
            isVisible
              ? 'opacity-100 translate-y-0' 
              : 'opacity-0 translate-y-8'
          }`}
        ...
        >
          <span className="font-semibold">lazy alarm</span> is a gentle excuse to slip away for a while. It's not here to optimize your sleep, track your rhythms, or launch you into action.
        </p>
